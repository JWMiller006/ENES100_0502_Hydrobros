...
#define TURN_SPEED 0.35f
#define GLOBAL_DRIVE_SPEED 1.0f

#define FORWARD_RIGHT_MOTOR_ENABLE 5
#define FORWARD_RIGHT_MOTOR_DRIVER_1 13
#define FORWARD_RIGHT_MOTOR_DRIVER_2 12
#define FORWARD_LEFT_MOTOR_ENABLE 3
#define FORWARD_LEFT_MOTOR_DRIVER_1 9
#define FORWARD_LEFT_MOTOR_DRIVER_2 8
#define REAR_RIGHT_MOTOR_ENABLE 4 // 2
#define REAR_RIGHT_MOTOR_DRIVER_1 10 // 10
#define REAR_RIGHT_MOTOR_DRIVER_2 11
#define REAR_LEFT_MOTOR_ENABLE 2
#define REAR_LEFT_MOTOR_DRIVER_1 6
#define REAR_LEFT_MOTOR_DRIVER_2 7
